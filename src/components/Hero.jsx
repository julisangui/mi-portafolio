      ...
      <>
        <div className="hero" id="Hero">
            ...
            <p className="presentacion">
              ...
              Llevo 2 años creando proyectos personales y colaborativos, que incluyen: desarrollo de aplicaciones web y móviles.
              Actualmente, continúo perfeccionándome en nuevas tecnologías y aprendiendo nuevas habilidades como el desarrollo de IA
